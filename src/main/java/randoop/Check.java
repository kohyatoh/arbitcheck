 ...
 * performed after statement i finishes executing.
 * 
 * <p>
 * 
...
public interface Check extends Serializable {
     ...
     * if these identifers match. The value is NOT included. with. Used to match
     * up checks between the same sequence run at different times. Note that
     * because of changes in the environment (eg, static variables), two
     ...
     * returning <code>true</code> if the check succeeded, and
