 ...
 * method call, constructor call, or primitive value declaration. </p>
 * 
 * An implementing class C should additionally provide the following:
 * 
 * <ul>
 * <li>A public static String field that contains a unique ID for the statement
 * kind.
 * <li>A public static parse(String) method that returns a new StatementKind
 * given a string description. The following property should hold:
 * C.parse(x.toParseableString()).equals(x)
 * <li>Update method StatementKinds.parse(String) to parse statement kinds of
 * type C.
 * <li>Update method StatementKinds.getId(StatementKing) to handle statement
 * kinds of type C.
 * </ul>
 */
