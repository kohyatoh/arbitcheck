...
public class RandoopSecurityManager extends SecurityManager {
    ...
    public void checkCreateClassLoader() {
        ...
        // throw new
        // SecurityException("checkCreateClassLoader: Randoop does not allow this operation by tested code");
    }
    ...
    public void checkExec(String cmd) {
        ...
        if (cmd == null)
            throw new NullPointerException();
        throw new SecurityException(
                "checkExec: Randoop does not allow this operation by tested code");
    }
    ...
    public void checkExit(int stat) {
        if (status == Status.OFF)
            return;
        throw new SecurityException(
                "checkExit: Randoop does not allow this operation by tested code");
    }
    ...
    public void checkRead(FileDescriptor fd) {
        ...
        if (fd == null)
            throw new NullPointerException();
        throw new SecurityException(
                "checkRead: Randoop does not allow this operation by tested code");
    }
    ...
    public void checkRead(String file) {
        ...
        if (file == null)
            throw new NullPointerException();
        // throw new
        // SecurityException("Randoop does not allow this operation by tested code");
    }
