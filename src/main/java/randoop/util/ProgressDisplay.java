...
public class ProgressDisplay extends Thread {
    ...
    public ProgressDisplay(AbstractGenerator generator,
            RandoopListenerManager listenerMgr, Mode outputMode,
            int progressWidth) {
        if (generator == null) {
...
//                clear();
    ...
    private void printStackTraceAndExit() {
        ...
        System.out.println();
        System.out
                .print("*** Randoop has detected no input generation attempts after ");
        System.out.println(exit_if_no_new_sequences_after_mseconds
                + " milliseconds.");
        System.out
                .println("This indicates Randoop may be executing a sequence");
        ...
        System.out.println();
        System.out
                .println("Will print all thread stack traces and exit with code 1.");

        for (Map.Entry<Thread, StackTraceElement[]> trace : Thread
