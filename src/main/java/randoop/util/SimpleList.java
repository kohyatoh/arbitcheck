 ...
 * sequences by concatenation existing sequences and appending a statement at
 * the end. A naive implementation of concatenation copies the elements of the
 * concatenated sub-sequences into a new list. The first implementation of
 * Sequence concatenation took this approach.
 * 
 * <p>
