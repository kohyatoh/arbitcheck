 ...
 * "START <recordtype>" and ending with the string "END <recordtype>" where
...
public class RecordListReader {
    ...
    public void parse(String inFile) {
        if (inFile == null || inFile.length() == 0)
            throw new IllegalArgumentException("Illegal input file name: "
                    + inFile);
    ...
    private List<String> readOneRecord(BufferedReader reader)
            throws IOException {
